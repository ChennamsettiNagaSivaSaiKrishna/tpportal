    ...
    <div className="portal-container">
      <header className="nav-container">
        <div style={{ fontWeight: '700', fontSize: '0.95rem', color: 'var(--text-title)', display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }} onClick={() => navigate('/')}>
          <div style={{ width: '12px', height: '12px', borderRadius: '3px', backgroundColor: 'var(--accent-color, #10b981)' }}></div>
          TP PORTAL
        </div>
      ...
      <div className="auth-wrapper">
        <div className="glass-auth-card" style={{ maxWidth: activeTab === 'register' ? '540px' : '420px', transition: 'max-width 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-group">
              <label className="form-label">Portal Identity Email<span className="mandatory-star">*</span></label>
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="form-input" placeholder="sai@institution.org" required />
...
export default UnifiedAuthGateway;