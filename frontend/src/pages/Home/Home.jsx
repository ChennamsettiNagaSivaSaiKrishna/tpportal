  ...
  return (
    <div className="landing-layout-wrapper">
          ...
          <div className="nav-public-group">
            <button
              ...
              className={`nav-link-btn ${
                activeTab === "home" ? "active-tab-link" : ""
              }`}
            >
              Home
            </button>
            ...
            {["student", "placement", "management", "admin"].map((role) => (
              <button
                ...
                className={`nav-role-btn ${
                  activeTab === role ? "active-role-highlight" : ""
                }`}
              >
      ...
      {activeTab === "home" ? (
          ...
          <section className="landing-hero-viewport">
            <div className="hero-content-workspace">
              <span className="hero-tag-badge">
                Accredited With National Excellence
              </span>
              <h1 className="hero-main-title">
                Engineering the Future.
                <br />
                <span className="highlight-text-stream">
                  Securing Elite Global Careers.
                </span>
              </h1>
              <p className="hero-description-paragraph">
                Welcome to the centralized Training & Placement ecosystem.
                Select your structural role entry key in the navigation utility
                panel above to instantly configure your gateway matrix tracking
                view.
              </p>
              <button
                onClick={() => handleTabChange("student")}
                className="hero-primary-action-btn"
              >
                Get Started &rarr;
              </button>
            </div>
          ...
          <section className="landing-metrics-container">
            <div className="metrics-section-heading">
              ...
              <h2 className="metrics-main-title">
                Corporate Recruitment Track Records
              </h2>
            </div>
          ...
          <section className="corporate-ticker-strip">
            <div className="ticker-wrapper-content">
              <div className="ticker-title-container">
                <span className="ticker-intro-title">
              ...
              <div className="marquee-track-window">
                <div className="ticker-brands-marquee">
                  {corporatePartners
                    .concat(corporatePartners)
                    .map((brand, index) => (
                      <span key={index} className="marquee-brand-item">
                        {brand}
                      </span>
                    ))}
                </div>
        ...
        <main className="context-main-panel">
          <div className="context-header-block">
            ...
            <h1 className="context-panel-title">
      ...
      <footer className="landing-global-footer">
        <p>
          &copy; 2026 Institute Campus Board | Centralized Training & Placement
          cell.
        </p>
      </footer>
    </div>
